...
type Poruka struct {
	...
	CntFail    int32  `protobuf:"varint,2,opt,name=cntFail,proto3" json:"cntFail,omitempty"`
...
func (x *Poruka) GetCntFail() int32 {
	if x != nil {
		return x.CntFail
	}
	return 0
...
func (x *Poruka) GetStart() *Start {
	if x, ok := x.GetMsg().(*Poruka_Start); ok {
		return x.Start
	}
	return nil
}

func (x *Poruka) GetFail() *Fail {
	if x, ok := x.GetMsg().(*Poruka_Fail); ok {
		return x.Fail
	}
	return nil
}
...
type Poruka_Start struct {
	Start *Start `protobuf:"bytes,6,opt,name=start,proto3,oneof"`
}

type Poruka_Fail struct {
	Fail *Fail `protobuf:"bytes,7,opt,name=fail,proto3,oneof"`
}
...
func (*Poruka_Start) isPoruka_Msg() {}

func (*Poruka_Fail) isPoruka_Msg() {}
...
func (x *Start) Reset() {
	*x = Start{}
	if protoimpl.UnsafeEnabled {
		mi := &file_poruke_poruke_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Start) Descriptor() ([]byte, []int) {
	return file_poruke_poruke_proto_rawDescGZIP(), []int{7}
}
...
func (x *Fail) Reset() {
	*x = Fail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_poruke_poruke_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Fail) Descriptor() ([]byte, []int) {
	return file_poruke_poruke_proto_rawDescGZIP(), []int{8}
}

func (x *Fail) GetFail() bool {
	if x != nil {
		return x.Fail
	}
	return false
...
var file_poruke_poruke_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x80, 0x02, 0x0a, 0x06, 0x50, 0x6f, 0x72, 0x75,
	...
	,
}
...
var file_poruke_poruke_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_poruke_poruke_proto_goTypes = []interface{}{
	...
	(*Start)(nil),   // 7: poruke.Start
	(*Fail)(nil),    // 8: poruke.Fail
}
var file_poruke_poruke_proto_depIdxs = []int32{
	...
	7, // 5: poruke.Poruka.start:type_name -> poruke.Start
	8, // 6: poruke.Poruka.fail:type_name -> poruke.Fail
...
func file_poruke_poruke_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_poruke_poruke_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Start); i {
			case 0:
				return &v.state
			case 1:
		...
		file_poruke_poruke_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Fail); i {
			case 0:
				return &v.state
			case 1:
