...
func NoviOperativac(id int, sl *Sluzba, a Actor) *Operativac {
	return &Operativac{
		pid:         id,
		sanduce:     make(chan interface{}, 10),
...
func (o *Operativac) Obradi(msg interface{}) bool {
